...
public class FileUtils {
    ...
    public static boolean isAllowUpload(String fileExtension, boolean throwException) {
        ...
        if (throwException) {
            throw new AppException(String.format("File có định dạng .%s chưa được hỗ trợ!", fileExtension));
        }
        return false;
    }
